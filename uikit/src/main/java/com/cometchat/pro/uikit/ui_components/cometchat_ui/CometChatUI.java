...
public class CometChatUI extends AppCompatActivity implements
    ...
    public  void logoutUser(View v){
        Snackbar.make(v,"Logging You Out",Snackbar.LENGTH_LONG).show();
        CometChat.logout(new CometChat.CallbackListener<String>() {
            @Override
            public void onSuccess(String s) {
                Intent intent = new Intent();
                intent.setComponent(new ComponentName("com.example.whatsapp", "com.example.whatsapp.MainActivity"));
                startActivity(intent);
            }

            @Override
            public void onError(CometChatException e) {
                Snackbar.make(v,"Error:"+e.getCode(),Snackbar.LENGTH_LONG).show();
            }
        });
    }
